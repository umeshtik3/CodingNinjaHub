...
chrome.storage.local.get('codingninjahub_token', (data) => {
    console.log(data.codingninjahub_token);
    console.log(data.leethub_token);
    ...
    xhr.addEventListener('readystatechange', function () {
      if (xhr.readyState === 4) {
        if (xhr.status === 200) {
          ...
          chrome.storage.local.set({ codingninjahub_token: null }, () => {
            console.log(
